  ...
  <transition name="list-fade">
    <div class="playlist" v-show="showFlag" @click="hide">
    	<div class="list-wrapper" @click.stop>
    		...
    		<scroll ref="listContent" class="list-content" :data="sequenceList" :refresgDelay="refreshDelay">
      ...
      <confirm 
        ref="confirm" 
        text="Are you sure to clear all the songs in playlist?"
...
<script>
  ...
  export default {
    ...
    computed: {
      modeText() {
        return this.mode === playMode.seqence ? 'SEQUENCE PLAY' : this.mode === playMode.random ? 'SHUFFLE PLAY' : 'REPEAT'
      }
      // ...mapGetters([
      //   'sequenceList',
      //   'currentSong',
